...
public class JeopardyGameApplication {

	public static ClueService clueService = new ClueService();

	public static void main(String[] args) {
//		SpringApplication.run(JeopardyGameApplication.class, args);

		JeopardyGameApplication.run();
	}
	...
	public static void run() {
		...
		while(game == null || game.getJeopardy() == null) {
			System.out.println();
			System.out.println();
			System.out.println("Enter a date in the format mm/dd/yyyy:");
			String date = scanner.nextLine();

//			String date = "05/20/2022";

			try {
				game = clueService.getGame(date);
				game.setClues();
			} catch (Exception e) {
				System.out.println();
				System.out.println("Could not find a game for that date.");
			}
		}
		...
		for(round = 1; round <= 2; round++) {
			...
			for (int cluesRemaining = 30; cluesRemaining > 0; cluesRemaining--) {
				...
				if (clueIndex == dailyDouble1 || clueIndex == dailyDouble2) {
					...
					if (game.getPlayers().get(playerInControl).getScore() > maxWager) {
						maxWager = game.getPlayers().get(playerInControl).getScore();        //Sets max wager to players score if they have more than value of highest question in the round
					}
					...
					System.out.println();
					System.out.println(cluesByRound[round - 1].get(clueIndex).getClue());
					System.out.println();
					...
					if (response.equalsIgnoreCase(cluesByRound[round - 1].get(clueIndex).getAnswer())) {
						System.out.println();
						System.out.println("Correct!");
						System.out.println();
						AudioPlayer.playSound(correctAnswerSound);
						//Adds wager to player's score if correct
						game.getPlayers().get(playerInControl).adjustScore(true, wager);
					} else {
						System.out.println();
						...
						game.getPlayers().get(playerInControl).adjustScore(false, wager);
					}

					System.out.println();
					System.out.println("Correct Response:");
					System.out.println("What is " + cluesByRound[round -1].get(clueIndex).getAnswer());
		...
		System.out.println();
		System.out.println("The category for Final Jeopardy is " + game.getFinalJeopardy().getCategory());
		System.out.println();
		game.showScoreBoard(game.getPlayers());
		System.out.println();
		...
		for(int i = 0; i < game.getPlayers().size(); i++){
			maxWager = game.getPlayers().get(i).getScore();
			...
			if(game.getPlayers().get(i).isEligibleForFinalJeopardy()) {
				...
				do {
					...
					if (wager > game.getPlayers().get(i).getScore()) {
						System.out.println("Cannot wager more than " + maxWager + ".");
						System.out.println();
						continue;
					}
		...
		System.out.println();
		System.out.println(game.getFinalJeopardy().getCategory());
		System.out.println();
		System.out.println(game.getFinalJeopardy().getClue());
		System.out.println();
		scanner.nextLine();
		...
		for(int i = 0; i < game.getPlayers().size(); i++) {
			if (game.getPlayers().get(i).isEligibleForFinalJeopardy()) {
				...
				System.out.println();
				//Check if correct
				if (response.equalsIgnoreCase(game.getFinalJeopardy().getAnswer())) {
					System.out.println("Correct!");
...
//                    AudioPlayer.playSound(incorrectAnswerSound);
		...
		System.out.println("Correct response:");
		System.out.println();
		System.out.println(game.getFinalJeopardy().getAnswer());
		System.out.println();
...
//		List<String> doubleJeopardyCategories = new ArrayList<>();
//
//		for(Clue clue: game.getJeopardy()){
//			if(!jeopardyCategories.contains(clue.getCategory())){
//				jeopardyCategories.add(clue.getCategory());
//			}
//		}
//
//		for(Clue clue: game.getDoubleJeopardy()){
//			if(!doubleJeopardyCategories.contains(clue.getCategory())){
//				doubleJeopardyCategories.add(clue.getCategory());
//			}
//		}

//
//		List<Clue> jeopardyCluesSorted = sortClues(game.getJeopardy(), 1);
//
//
//
//		for(Clue clue : jeopardyCluesSorted){
//			System.out.println();
//			if(clue == null){
//				System.out.println("Clue not found.");
//			}
//			System.out.println(clue.getCategory());
...
//	}
//
//	public static List<Clue> sortClues(Clue[] clues, int round) {
